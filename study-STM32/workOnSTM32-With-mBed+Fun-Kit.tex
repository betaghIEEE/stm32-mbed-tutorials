...
The basic notion of a class provides an encapsulation of member properties and action methods.   Basic automata theory captures some of the basics of object oriented programming as input, states, and outputs.  
